...
$(OBJDIR)/main.o: main.c main.h csa_alloc.h engineering.h healthbars.h firstmate.h tracker.h csa_error.h
	$(CC) $(CFLAGS) $(GTK_CFLAGS) $(LUAJIT_CFLAGS) -c -o $(OBJDIR)/main.o main.c

$(OBJDIR)/csa_alloc.o: csa_alloc.c csa_alloc.h
	$(CC) $(CFLAGS) -c -o $(OBJDIR)/csa_alloc.o csa_alloc.c

$(OBJDIR)/csa_error.o: csa_error.c csa_error.h
	$(CC) $(CFLAGS) -c -o $(OBJDIR)/csa_error.o csa_error.c

$(OBJDIR)/accelerated.o: accelerated.cpp accelerated.h main.h csa_alloc.h tracker.h
ifeq ($(USE_VCL),1)
	$(UNZIP) vcl.zip
endif
	$(CXX) $(CXXFLAGS) $(GTK_CFLAGS) $(LUAJIT_CFLAGS) -DUSE_VECTORS=$(USE_VCL) -c -o $(OBJDIR)/accelerated.o accelerated.cpp

$(OBJDIR)/maprender.o: maprender.c tracker.h main.h csa_alloc.h accelerated.h csa_error.h
	$(CC) $(CFLAGS) $(GTK_CFLAGS) $(LUAJIT_CFLAGS) -c -o $(OBJDIR)/maprender.o maprender.c

$(OBJDIR)/tracker.o: tracker.c tracker.h main.h csa_alloc.h csa_error.h
	$(CC) $(CFLAGS) $(GTK_CFLAGS) $(LUAJIT_CFLAGS) -c -o $(OBJDIR)/tracker.o tracker.c

$(OBJDIR)/firstmate.o: firstmate.c firstmate.h main.h csa_alloc.h
	$(CC) $(CFLAGS) $(GTK_CFLAGS) -c -o $(OBJDIR)/firstmate.o firstmate.c

$(OBJDIR)/engineering.o: engineering.c engineering.h main.h csa_alloc.h
	$(CC) $(CFLAGS) $(GTK_CFLAGS) -c -o $(OBJDIR)/engineering.o engineering.c

$(OBJDIR)/healthbars.o: healthbars.c healthbars.h main.h csa_alloc.h
...
$(OBJDIR)/testbench.o: testbench.c main.h csa_alloc.h tracker.h accelerated.h csa_error.h
